"""
Legacy copy: prefer running test.py from the project root instead.
  From project root: python test.py [zip] "item1,item2"
  Output: data/temp_results.csv

This file runs the same logic but resolves paths relative to temp/.
"""
import sys
import csv
...
# When run from temp/, this writes to temp/data/; use root test.py for data/temp_results.csv
